...
class Shop_UserController extends Zend_Controller_Action
{
    protected $_defaultInjections = array(
        'Form_Register' => 'Shop_Form_Register',
        'Form_Quick'   => 'Shop_Form_OrderQuickUser',
    );
    ...
    {
        $params = $this->getRequest()->getParams();
        $siteName = Zend_Registry::get('shop_config')->www->siteName;
        $adminEmail = Zend_Registry::get('shop_config')->email->support;
