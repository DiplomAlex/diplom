...
function settingsDeploy()
{
	...
	siteDomain='cutecms.ru'
	siteName='cutecms.ru'
	supportEmail='info@cutecms.ru'
	supportName='Support'

	ftpHost='ftp.cutecms.ru'
	ftpUser=''
	ftpPassword=''
	ftpPath=''
...
function makeArchive()
{
	...
	cat ./$development/$installPhp ./$productionZip.enc > ./$installPhp
...
if [ "$action" == 'archive' ]; then
	...
	echo "usage: deployer.sh [archive|install|update]"
fi
