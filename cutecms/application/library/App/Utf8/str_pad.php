...
function _str_pad($str, $final_str_length, $pad_str = ' ', $pad_type = STR_PAD_RIGHT)
{
	...
	if ($pad_type == STR_PAD_BOTH)
	{
		...
		$pad_left = App_Utf8::substr(str_repeat($pad_str, $repeat_left), 0, $pad_length_left);
		$pad_right = App_Utf8::substr(str_repeat($pad_str, $repeat_right), 0, $pad_length_left);
		return $pad_left.$str.$pad_right;
	}

	trigger_error('App_Utf8::str_pad: Unknown padding type (' . $type . ')', E_USER_ERROR);
}