...
class Checkout_Model_Service_Payment extends Model_Service_Abstract
{

    protected $_defaultInjections = array(
        'Model_Object_Interface'     => 'Checkout_Model_Object_Payment',
        'Model_Collection_Interface' => 'Checkout_Model_Collection_Payment',
        'Model_Mapper_Interface'     => 'Checkout_Model_Mapper_Config_Payment',
    );
    ...
    public function getAll($style = Model_Object_Interface::STYLE_CUSTOM)
    {
        ...
        $allConfig = $this->_getBruleService()->getAll(Checkout_Model_Service_Brule::TYPE_PAYMENT);
    ...
    public function getComplex($id)
    {
        ...
        if ( ! $found) {
            $this->_throwException('payment "'.$id.'" is not installed');
        }
        return $found;
    }
    ...
    public function save(Model_Object_Interface $object)
    {
        ...
        $this->_getBruleService()->save($config, $object->method, Checkout_Model_Service_Brule::TYPE_PAYMENT);
        return $this;
    }
    ...
    public function changeSorting($method, $position)
    {
        ...
        $this->_getBruleService()->save($config, NULL, Checkout_Model_Service_Brule::TYPE_PAYMENT);
        return $this;
    }
