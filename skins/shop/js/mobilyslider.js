...
(function ($) {
    $.fn.mobilysliderHomeTop = function (options) {
        var defaults = {
            content: ".sliderContent",
            children: "div",
            transition: "horizontal",
        ...
        return this.each(function () {
            ...
            var slider = {
                ...
                bullets: {
                    ...
                    trigger: function () {
                        bullet = bullets.find(".home_menu_block");
                        bullet.eq(0).addClass("home_menu_block_active");
                        bullet.click(function () {
                            var b = $(this),
                                rel = b.data("slide");
                            active = bullet.filter(".home_menu_block_active").data("slide");
                            step = rel;
                            sign = rel > active ? "+" : "-";
                            z = 0;
                            if (!b.hasClass("home_menu_block_active")) {
                                switch (sets.transition) {
                                    case "horizontal":
                                        slider.slide.left(sign);
                                        break;
                            ...
                            bullet.removeClass("home_menu_block_active");
                            b.addClass("home_menu_block_active");
                            return false
                        })
                    },
                    update: function () {
                        bullet.removeClass("home_menu_block_active").eq(step).addClass("home_menu_block_active")
                    }
                },
                arrows: {
                    create: function () {
